    ...
    <div className="flex flex-col">
        ...
        <div className="flex flex-row h-[95vh]">
          ...
          <div className="h-[100%] px-[32px] pt-[17px] pb-[28px] w-full flex flex-col bg-[#0F1011]" onClick={handleClick}>
            ...
            <div className="mb-[22px] flex flex-row w-full">
              ...
              >
                <h1 className="text-[#C3C3C3] hover:text-white self-center">{timeView}</h1>
                {timestate && (
      <div className="flex flex-col absolute top-[50px]">
        <div 
          ...
          className="relative w-[233px] border-[1px] border-[#323135] h-[40px] bg-[#0E0E0F] hover:border-white flex justify-center rounded-[10px]"
        >
          <h1 className="text-[#C3C3C3] hover:text-white self-center">Week</h1>
        </div>
        <div 
          onClick={timeSwitch}
        ...
        >
          <h1 className="text-[#C3C3C3] hover:text-white self-center">Month</h1>
        </div>
        <div 
          onClick={timeSwitch}
          className="relative w-[233px] mt-3 border-[1px] border-[#323135] h-[40px] bg-[#0E0E0F] hover:border-white flex justify-center rounded-[10px]"
        >
          <h1 className="text-[#C3C3C3] hover:text-white self-center">Year</h1>
        </div>
      </div>
    )}
              </div>
              ...
              <div className="w-[233px] border-[1px] border-[#323135] h-[40px] hover:border-white bg-[#0E0E0F] flex justify-center rounded-[10px]">
                <h1 className="text-[#C3C3C3] hover:text-white self-center">Demographics</h1>
              </div>
            </div>
            {view === "chart" ? (
              <>
