  ...
  render() {
    return (
      <Draggable handle=".handle">
        <StyledView className="w-[29px] h-[119px] rounded-[4.33px] absolute right-0 top-1/2 transform -translate-y-1/2 flex flex-col bg-[#C3C3C3] opacity-[60%] items-center">
          <StyledView className="handle w-full border-b-2 border-black flex justify-center items-center">
            <StyledSvg xmlns="http://www.w3.org/2000/svg" className="mb-[8px] mt-[10px]" width="24" height="24" viewBox="0 0 256 256">
          ...
          <StyledSvg xmlns="http://www.w3.org/2000/svg" className="mt-[8px]" width="24" height="24" viewBox="0 0 32 32">
            <path fill="black" d="M21.25 8.375V28h6.5V8.375zM12.25 28h6.5V4.125h-6.5zm-9 0h6.5V12.625h-6.5z"/>
          </StyledSvg>

          <StyledSvg xmlns="http://www.w3.org/2000/svg" className="mt-[8px]" width="24" height="24" viewBox="0 0 1024 1024">
          ...
          <StyledSvg xmlns="http://www.w3.org/2000/svg" className="mt-[8px]" width="24" height="24" viewBox="0 0 256 256">
