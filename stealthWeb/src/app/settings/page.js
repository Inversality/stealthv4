        ...
        <div className="flex flex-col flex justify-center items-center w-[100%]">
          ...
          <div className="w-[460px] h-[558px] bg-[#161616] rounded-[11px] flex justify-center items-center">
            <div>
              ...
              <button type="submit" disabled={isRegistering || !emailAvailable} class=" mt-[32px] mb-[18px] w-[38px] h-[25px] bg-[#0F1011] rounded-[9.27px] flex justify-center self-center items-center">
